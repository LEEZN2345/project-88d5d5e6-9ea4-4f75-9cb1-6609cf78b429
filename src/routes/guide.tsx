...
const PAGE_GUIDES: {
  ...
  },
  {
    ...
    to: "/me",
    buttons: [
      { name: "会员卡区", desc: "查看当前等级（游客 / 普通 ¥99 / 钻石会员 ¥199），点击升级。" },
  ...
  },
  {
    ...
    to: "/membership",
    buttons: [
      { name: "开通黄金会员 ¥99/年", desc: "享受基础返佣抵扣 + 满 ¥300 免运费。" },
      { name: "升级钻石会员 ¥199/年", desc: "解锁提现权限、L1/L2 邀请返佣、3% 创作返佣。" },
    ],
  },
  {
    icon: Coins,
  ...
  },
  {
    ...
    buttons: [
      ...
      { name: "立即提现", desc: "钻石会员可提现至支付宝 / 微信 / 银行卡，未升级会引导升级。" },
