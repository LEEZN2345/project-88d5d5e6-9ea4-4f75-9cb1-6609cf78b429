...
const SCENARIO_BADGE: Record<string, { label: string; variant: "default" | "secondary" | "outline" | "destructive" }> = {
...
function AdminRefunds() {
  return (
    <AdminShell>
      ...
      <p className="mb-1 text-xs text-muted-foreground">两级审核:客服提单 → 财务复核 → 打款。两级操作人分别落库。</p>
        ...
        <table className="w-full text-sm">
          ...
          <tbody>
            {REFUNDS.map((r) => {
              ...
              const sc = SCENARIO_BADGE[r.scenario];
              return (
