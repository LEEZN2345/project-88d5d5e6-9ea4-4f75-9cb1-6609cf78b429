...
export const MALLS: Mall[] = [
  {
    ...
    buildings: [
      ...
      { name: "Shin Pyunghwa A", floors: ["B1", "1F", "2F", "3F", "4F"] },
      { name: "Shin Pyunghwa B", floors: [] },
      { name: "Shin Pyunghwa C", floors: [] },
      { name: "Pyunghwa Market", floors: [] },
      { name: "JABA11", floors: ["B01", "1F", "2F"] },
      { name: "Art Plaza", floors: ["B1", "1F", "2F", "3F"] },
      { name: "SANGSANG(Essor)", floors: ["B1", "1F", "2F", "3F"] },
      { name: "Dongmun Mall", floors: ["1F", "2F", "3F", "4F"] },
      { name: "Cheonggye Mall", floors: [] },
      { name: "Seopyunghwa", floors: [] },
      { name: "General Market", floors: [] },
      { name: "Tongil Mall", floors: [] },
      { name: "Dongil Mall", floors: [] },
      { name: "NYUNYU", floors: ["1F", "2F", "3F", "4F", "5F", "6F"] },
      { name: "pikdaeji", floors: [] },
    ],
  },
  {
    city: "南大门",
